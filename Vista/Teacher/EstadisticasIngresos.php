          ...
          <div>
            <table class="table text-center table-hover small">
              <tr class="info">
                      ...
                      <?php
                      $resultado=$clase->EsIng($desde,$hasta);
                      $numperson = $resultado->num_rows;
                      $resultado1=$clase->EsIngVeh($desde,$hasta);
                      $numveh = $resultado1->num_rows;
                      $resultado2=$clase->EsIngPor($desde,$hasta);
                      ...
                      $resultado=$clase->ConsultaIngreso($desde,$hasta);

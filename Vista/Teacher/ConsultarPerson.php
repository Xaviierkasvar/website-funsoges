  ...
  <body background="../img/2.jpg">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 mx-auto">
            <a class=" float-left" href="UserOper.php"><img  src="../img/16.png" width="60" height="60" class="img-fluid "></a>
            <a class=" float-right" href="../salir.php"><img src="../img/salir.svg" width="60" height="60" align="bottom"class="img-fluid"></a>
            <h1 class="text-center m-3" style="color:white;">Consultar Personal</h1>            
          </div>
        </div>
      </div>
    </header>
    ...
    ?>
          ...
          <div class="col-4" style="margin-bottom: 60px;">
                        <?php
              if ($msj==1)
                 echo '<br><br><div class="alert alert-danger text-center">Personal registrado exitosamente</div>';
               if ($msj==2)
                 echo '<br><br><div class="alert alert-info text-center">Error al intentar registrar el Personal</div>';
               if ($msj==3)
                 echo '<br><br><div class="alert alert-info text-center">Error al intentar actualizar el Personal</div>';
               if ($msj==4)
                 echo '<br><br><div class="alert alert-info text-center">Personal actualizado exitosamente</div>';
              ?>
                  <form class="tc" action="../../Controlador/ValidarPersonOp.php" method="get">

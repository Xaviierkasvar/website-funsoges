  ...
  <body background="../img/2.jpg">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 mx-auto">
            ...
            <h1 class="text-center m-3" style="color:white;">Consultar Operador</h1>            
          </div>
        </div>
      </div>
    </header>
    ...
    ?>
          ...
          <div class="col-4" style="margin-bottom: 60px;">
                        <?php
              if ($msj==1)
                 echo '<br><br><div class="alert alert-danger text-center">Operador registrado exitosamente</div>';
               if ($msj==2)
                 echo '<br><br><div class="alert alert-info text-center">Error al intentar registrar el Operador</div>';
               if ($msj==3)
                 echo '<br><br><div class="alert alert-info text-center">Error al intentar actualizar el Operador</div>';
               if ($msj==4)
                 echo '<br><br><div class="alert alert-info text-center">Operador actualizado exitosamente</div>';
              ?>
                  <form class="tc" action="../../Controlador/ValidarOper.php" method="get">
    ...
    <footer>
      <div class="fixed-bottom bg-dark">
        <h5 class="text-white text-center tb">Todos los derechos reservados &copy. SADIYS (Sistema Automatizado Ingreso y Salida)  Junio-2018</h5>
       </div>
    </footer>
    </div>

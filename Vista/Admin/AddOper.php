  ...
  <body background="../img/2.jpg">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 mx-auto">
            ...
            <h1 class="text-center m-3" style="color:black;">Agregar Nuevo Operador</h1>            
          </div>
        </div>
      </div>
    </header>
    <section>
      <div class="container">
        <div class="row">
          <div class="col-3">
            <img class="img-thumbnail img-responsive" src="img/14.png">
          </div>
          <div class="col-6 tf" style="margin-bottom: 60px;">
                  <form name="form1" id="form1" action="../../Controlador/AddOper.php" method="POST">
                      ...
                      <input type="password" name="key1" required class="form-control" id="key1">
                      ...
                      <input type="text" value="<?php echo $ced;?>" class="form-control" invisible placeholder="Digite numero" id="cedula" name="cedula" style="display:none">
                      <input type="number"  value="<?php echo $_SESSION["id"]; ?>" placeholder="<?php echo $$_SESSION["id"];?>" class="form-control"  name="id" id="id" style="display:none">
                  </form></th>
              </tbody>
            </table>
        </div>

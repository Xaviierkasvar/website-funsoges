      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 mx-auto">
            <a class=" float-left" href="ConsultarAdmin.php"><img  src="../img/16.png" width="60" height="60" class="img-fluid "></a>
            <a class=" float-right" href="../salir.php"><img src="../img/salir.svg" width="60" height="60" align="bottom"class="img-fluid"></a>
            <h1 class="text-center m-3" style="color:black;">Agregar Nuevo Administrador</h1>            
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-6 tf" style="margin-bottom: 60px;">
                  <form name="form1" id="form1" action="../../Controlador/AddAdmin.php" method="POST">
